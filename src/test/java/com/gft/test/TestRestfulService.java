...
public class TestRestfulService {
	...
	public void setUp() throws Exception {
		temporaryShops = Arrays.asList(new Shop("shop_N1", 1, "46185", "ES", null, null, null, null),
	...
	public void saveNewShop() throws Exception {
		...
		this.mockMvc.perform(post("/shops/").contentType(MediaType.APPLICATION_JSON_UTF8).content(jsonShop))
